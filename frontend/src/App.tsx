...
function App() {
    ...
    const fetchHotels = (city = '', price = 500000) => {
                    ...
                    <div className="bg-[#003580] pb-16 pt-8">
                        <div className="container mx-auto px-4">
                            ...
                            <p className="text-blue-200 mb-6 text-sm">
                                Найдите идеальное жильё для вашей поездки
                            </p>
                                ...
                                <div className="bg-white rounded-md flex flex-col md:flex-row">
                                    ...
                                    <div className="flex items-center gap-2 px-4 py-3 flex-1 border-b md:border-b-0 md:border-r border-gray-200">
                                        ...
                                        <input
                                            ...
                                            onKeyDown={e => e.key === 'Enter' && fetchHotels(searchCity, maxPrice)}
                                        />
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <button
                                                    ...
                                                    className="w-6 h-6 rounded-full border border-blue-600 text-blue-600 font-bold text-lg flex items-center justify-center hover:bg-blue-50"
                                                >−</button>
                                    ...
                                    {/* Кнопка поиска */}
                                    <button
                                        onClick={() => fetchHotels(searchCity, maxPrice)}
                                ...
                                {hotels.length === 0 ? (
                                    ...
                                    <div className="flex flex-col gap-4">
                                        {hotels.map(h => (
                                            <div
                                                key={h.id}
                                                className="bg-white rounded-lg border shadow-sm hover:shadow-md transition-shadow flex overflow-hidden"
                                            >
